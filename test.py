...
def shit():
    if topic_name == "Linear Equations":
        a = AlgebraQuestions()
        tex_ques, tex_ans = a.getLinearEquationQuestion(data["Parameters"][difficulty], noofQuestions)
    elif topic_name == "System of Linear Equations":
        a = AlgebraQuestions()
        tex_ques, tex_ans = a.getSystemofLinearEquationQuestion(data["Parameters"][difficulty], noofQuestions)
    elif topic_name == "Quadratic Factorization":
        a = AlgebraQuestions()
        tex_ques, tex_ans = a.quadraticFactorizationQuestion(data["Parameters"][difficulty], noofQuestions)
